#!/bin/bash -ex
GRCOV_VERSION="v0.10.5"
MERCURIAL_VERSION="7.2"
VERSION_CONTROL_TOOLS_REV="5b6e8298d035"
...
# Setup grcov
curl -L https://github.com/mozilla/grcov/releases/download/$GRCOV_VERSION/grcov-x86_64-unknown-linux-gnu-tc.tar.bz2 | tar -C /usr/bin -xjv
