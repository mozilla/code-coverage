...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("test-android-em-14-x86_64-ccov/opt-geckoview-mochitest-plain-1", True),
        ...
        ("test-windows10-64-ccov-qr/debug-mochitest-1", True),
        ("test-windows10-64-ccov-qr/debug-mochitest-e10s-7", True),
        ("test-windows10-64-ccov-qr/debug-cppunit", True),
        ("build-linux64-ccov/debug", True),
        ("build-linux64-ccov/opt", True),
        ("build-android-x86_64-ccov/opt", True),
        ("build-win64-ccov/debug", True),
        ("test-linux64/debug-mochitest-1", False),
        ("test-windows10-64/debug-cppunit", False),
        ("test-windows10-64-qr/debug-cppunit", False),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "test-android-em-14-x86_64-ccov/opt-geckoview-mochitest-plain-1",
            "geckoview-mochitest-plain-1",
        ),
        ...
        ("test-windows10-64-ccov-qr/debug-mochitest-1", "mochitest-1"),
        ("test-windows10-64-ccov-qr/debug-mochitest-e10s-7", "mochitest-7"),
        ("test-windows10-64-ccov-qr/debug-cppunit", "cppunit"),
        ("build-linux64-ccov/opt", "build"),
        ("build-android-x86_64-ccov/opt", "build"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("test-windows10-64-ccov-qr/debug-mochitest-1", "mochitest-1"),
        (
            "test-windows10-64-ccov-qr/debug-mochitest-e10s-7",
            "mochitest-plain-chunked-7",
        ),
        ("test-windows10-64-ccov-qr/debug-cppunit", "cppunittest-1"),
        ("build-linux64-ccov/opt", "build"),
        ("build-android-x86_64-ccov/opt", "build"),
        ("build-win64-ccov/debug", "build"),
        ("build-signing-win64-ccov/debug", "build-signing"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("test-windows10-64-ccov-qr/debug-mochitest-1", "mochitest"),
        ("test-windows10-64-ccov-qr/debug-mochitest-e10s-7", "mochitest-plain-chunked"),
        ("test-windows10-64-ccov-qr/debug-cppunit", "cppunittest"),
        ("build-linux64-ccov/opt", "build"),
        ("build-android-x86_64-ccov/opt", "build"),
        ("build-win64-ccov/debug", "build"),
        ("build-signing-win64-ccov/debug", "build-signing"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("test-android-em-14-x86_64-ccov/opt-geckoview-mochitest-plain-1", "android"),
        ...
        ("test-windows10-64-ccov-qr/debug-mochitest-1", "windows"),
        ("test-windows10-64-ccov-qr/debug-mochitest-e10s-7", "windows"),
        ("test-windows10-64-ccov-qr/debug-cppunit", "windows"),
        ("build-linux64-ccov/opt", "linux"),
        ("build-android-x86_64-ccov/opt", "android"),
